...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from ZeroClaw\",
    \"comments\": [
...
gh pr review $PR_NUMBER --approve --body "Reviewed by ZeroClaw. Code looks clean — good test coverage, no security concerns."
