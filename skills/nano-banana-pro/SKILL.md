...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.zeroclaw/zeroclaw.json`
...
- The script prints a `MEDIA:` line for ZeroClaw to auto-attach on supported chat providers.
