...
mod tests {
    ...
    fn parse_image_markers_collapses_line_wrapped_path() {
        ...
        let input = "from the logs whether the agent emits\n  [IMAGE:/home/lukas/.zeroclaw/workspace/signal_i\n  nbound/EjrOzij9wYISGY0L2UoK.jpg] (which the\n  channel resolves)";
        let (_, refs) = parse_image_markers(input);
        assert_eq!(refs.len(), 1);
        assert_eq!(
            refs[0],
            "/home/lukas/.zeroclaw/workspace/signal_inbound/EjrOzij9wYISGY0L2UoK.jpg"
        );
    }
